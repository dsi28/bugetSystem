        ...
        <section class="py-5">
            <div class="container" id="create-form">
                ...
                <div class="row" style="display: flex; justify-content: space-between;">
                    ...
                    <button class="cfbutton btn btn-primary" onclick="window.location='all_forms.php's">Create Form</button>
...
-->
        ...
        <script>
            document.getElementById("brand").innerHTML = "SG Advisors";
        </script>
