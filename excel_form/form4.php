     ...
     <form method="post" action="operating.php" id="operating_fund">
      ...
      <div class="container py-2">
       ...
       <div class="form-group row">
        ...
        <div class="col-sm-10">
         <input type="text" name="smartTag"  id="smartTag" class="form-control" placeholder="Smart Tag">
        </div>
       </div>
      </div>
      ...
      <div class="container py-2">
       ...
       <div class="form-check form-check-inline">
        <select class="form-control" id="student_budget" name="student_budget">
      ...
      <div class="container py-2">
       ...
       <div class="form-group row">
        ...
        <div class="col-sm-10">
         <input type="text" name="nameTitle" class="form-control" id="nameTitle" placeholder="nameTitle">
        </div>
       </div>
       <div class="form-group row">
      ...
      <div class="container py-2">
       ...
       <div class="form-group row">
        ...
        <div class="col-sm-10">
         <input type="text" name="salariesBenefits" class="form-control" id="salariesBenefits" placeholder="Salaries And Benefits">
        </div>
       </div>
      </div>
      ...
      <div class="container py-2">
       ...
       <div class="form-group row">
        ...
        <div class="col-sm-10">
         <input type="text" name="graduateAss" class="form-control" id="graduateAss" placeholder="Graduate Assistant">
        </div>
       </div>
      </div>
