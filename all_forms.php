        ...
        <section class="py-5">
            <div class="container" id="create-form" class="input-group">
                ...
                <div class="row" style="display: flex; justify-content: space-between;">
                    <button type="button" name="form" value="form2" id="2" class="btn btn-primary lead" onclick="formElected(this.id)">Reserve Fund</button>
                    <button type="button" name="form" value="form3" id="3" class="btn btn-primary lead" onclick="formElected(this.id)">Reserve Fund OPS</button>
