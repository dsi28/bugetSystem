...
<html lang="en">
        ...
        <section class="py-5">
            <div class="container" id="create-form" class="input-group">
                ...
                <div class="row" style="display: flex; justify-content: space-between;">
                    <button type="button" name="form" value="form2" id="form2" class="btn btn-primary lead" onclick="formElected(this.id)">Form2</button>
                    <button type="button" name="form" value="form3" id="form3" class="btn btn-primary lead" onclick="formElected(this.id)">Form3</button>
                    <button type="button" name="form" value="form4" id="form4" class="btn btn-primary lead" onclick="formElected(this.id)">Form4</button>
                    <button type='button' 
                            <?php if($_SESSION['role']=='ACCOUNT') {
                            ?> disabled="disabled" style="visibility: hidden;"<?php } ?>
                            name="form" id="form1" class=" btn btn-primary" onclick="formElected(this.id)">Form 1</button>
            </div>
            <br>
            <br>
            <br>
    ...
    <footer  class="py-1 btn-red_fau fixed-bottom">
        ...
        function formElected(id){
            ...
            xmlhttp.open('POST', 'formelection.php');
            xmlhttp.send(dat);
        }
